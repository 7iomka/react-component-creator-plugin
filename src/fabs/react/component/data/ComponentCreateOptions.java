...
public class ComponentCreateOptions extends AbstractOptions {
    ...
    private String indexTemplateFile = defaultIndexTemplateFile;

    private final String INDEX_CHECKBOX_KEY = "INDEX_CHECKBOX_KEY";
    ...
    public void setCreateIndexFile(Boolean createIndexFile) {
        isCreateIndexFile = createIndexFile;
    }
    ...
    public boolean isCreateIndexDefaultChecked() {
        return isCreateIndexDefaultChecked;
    }
    ...
    public boolean equals(ComponentCreateOptions options) {
        return (options.getComponentTemplateFile().equals(componentTemplateFile)
                ...
                && options.getIndexTemplateFile().equals(indexTemplateFile)
                && options.isCreateIndexDefaultChecked() == isCreateIndexDefaultChecked
